                 ...
                 <div v-else>
                    <table class="w-full text-left">
                        ...
                        <tbody v-if="store.countries.length > 0">
                            <tr v-for="country in store.countries" :key="country.id"
                                class="border-b border-gray-200 hover:bg-gray-50">
                                <td class="py-4 px-6">{{ country.nombre }}</td>
                                <td class="py-4 px-6 text-center space-x-2">
                                    ...
                                    <button @click="confirmDelete(country.id)"
                        ...
                        <tbody v-else>
                           <tr>
                              <td colspan="2" class="text-center py-8 text-gray-500">No se encontraron países.</td>
                           </tr>
                        </tbody>
                    </table>
                 </div>
        ...
        <div v-if="isModalOpen" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
                ...
                <form @submit.prevent="handleSave">
                    <div class="mb-6">
                        <label for="nombre" class="block text-gray-700 font-semibold mb-2">Nombre del País</label>
